...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__18966__auto__,writer__18967__auto__,opt__18968__auto__){
return cljs.core._write.call(null,writer__18967__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__20026 = o;
(G__20026[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__20027__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__20027 = function (var_args){
var args = null;
...
while (G__20028__i < G__20028__a.length) {G__20028__a[G__20028__i] = arguments[G__20028__i + 0]; ++G__20028__i;}
  args = new cljs.core.IndexedSeq(G__20028__a,0);
} 
return G__20027__delegate.call(this,args);};
G__20027.cljs$lang$maxFixedArity = 0;
G__20027.cljs$lang$applyTo = (function (arglist__20029){
var args = cljs.core.seq(arglist__20029);
return G__20027__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__18348__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__18348__auto__){
var and__18348__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__18348__auto____$1){
var and__18348__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
if(cljs.core.truth_(and__18348__auto____$2)){
...
var G__20034 = jsprops;
(G__20034["defaultValue"] = value);

(G__20034["onChange"] = ((function (G__20034,v,value,on_change){
return (function (p1__20032_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__20032_SHARP_);
});})(G__20034,v,value,on_change))
);
...
var vec__20039 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__20039,(0),null);
var id = cljs.core.nth.call(null,vec__20039,(1),null);
var class$ = cljs.core.nth.call(null,vec__20039,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___20042 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___20042 == null)){
} else {
var key_20043 = temp__4661__auto___20042;
(jsprops["key"] = key_20043);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__20045 = (new reagent.impl.template.NativeWrapper());
(G__20045["name"] = c);
...
var len__19430__auto___20051 = arguments.length;
var i__19431__auto___20052 = (0);
while(true){
if((i__19431__auto___20052 < len__19430__auto___20051)){
args__19437__auto__.push((arguments[i__19431__auto___20052]));

var G__20053 = (i__19431__auto___20052 + (1));
i__19431__auto___20052 = G__20053;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__19438__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq20049){
var G__20050 = cljs.core.first.call(null,seq20049);
var seq20049__$1 = cljs.core.next.call(null,seq20049);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__20050,seq20049__$1);
});
...
break;
default:
var G__20057 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__20057;
continue;
...
var n__19275__auto___20058 = a.length;
var i_20059 = (0);
while(true){
if((i_20059 < n__19275__auto___20058)){
(a[i_20059] = reagent.impl.template.as_element.call(null,(a[i_20059])));
...
var a = cljs.core.into_array.call(null,s);
var n__19275__auto___20061 = a.length;
var i_20062 = (0);
while(true){
if((i_20062 < n__19275__auto___20061)){
var val_20063 = (a[i_20062]);
if((cljs.core.vector_QMARK_.call(null,val_20063)) && ((reagent.impl.template.key_from_vec.call(null,val_20063) == null))){
(o["no-key"] = true);
} else {
}

(a[i_20062] = reagent.impl.template.as_element.call(null,val_20063));

var G__20064 = (i_20062 + (1));
i_20062 = G__20064;
continue;
} else {
}
...
var ctx = {};
var vec__20066 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__20066,(0),null);
var derefed = cljs.core.nth.call(null,vec__20066,(1),null);
...
var G__20068 = (cljs.core.count.call(null,argv) - first_child);
switch (G__20068) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__20068){
...
//# sourceMappingURL=template.js.map?rel=1464365886615